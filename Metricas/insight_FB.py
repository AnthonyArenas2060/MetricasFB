        ...
        if not info.empty:
            ...
            if indice:
                ...
                if not posteos.empty:
                    ...
                    analisis_imagen = st.radio(
                        "¿Quieres que se haga un análisis del texto de las imágenes?",
                        ["Sí", "No"]
                    )
                    
                    st.write("Seleccionaste:", analisis_imagen)
                    if analisis_imagen == "Sí":
                        if indice == 13:
                 ...
                 # ============================
                    ...
                    if post1ig and post2ig and post1ig != post2ig:
                        ...
                        # Extraer métricas relevantes
                        columnas_metricas2 = [
                            "reach", "total_interactions", "ER (%)", "likes",
